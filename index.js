...
const PAGE_ACCESS_TOKEN = 'EAAZAKO1ZBJHgYBAFmD1ufa1nH0JjjZCZBHmdvt8e8jPLPyg6iTJMzs99OBGbH12FbeIXuhMyY6mR1trkTlOLeRi2XTcgTPYx3wILQxOmqXqRUDW7EhIBjwEZAsc5MLGeMCYg85KmURn8hDGpAuyJeZBWAsR5iGVm2ArJZCiTBtcuS5GJArTM5ZAk';
...
function getMyInfo(recipientID) {
    ...
    request({
        ...
        for (repo in body) {
            imageUrl = body[repo]['owner']['avatar_url'];
            var temp = {
